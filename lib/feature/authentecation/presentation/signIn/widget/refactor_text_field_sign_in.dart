      ...
      child: Column(
        ...
        children: [
          ...
          CustomTextFormField(
              ...
              suffixIcon: Icon(Icons.email_outlined , color: AppColor.kPrimaryColor, size: 30,)
          ),
          verticalSpacing(10),
          Align(
              alignment: Alignment.topRight,
          ...
          TextButton(
            ...
            child:Align(
              alignment: Alignment.topRight,
              child: Text("نسيت كلمه السر ؟", textAlign :TextAlign.end,style: TextStyle(
                fontSize: 20,
          ...
          verticalSpacing(30),
          state is AppLoginLoadingState ? CircularProgressIndicator()
         : CustomMaterialBottons(
          ...
          Row(
            ...
            children: [
              Text(ConstText.notHaveAcount , style: AppStyle.font17W400.copyWith(color: Colors.black),),
              TextButton(onPressed: (){
                Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => SignUpScreen(),));
              },
                  child: Text(ConstText.createNewAcount, style: AppStyle.font17W400.copyWith(color: AppColor.kPrimaryColor),)
              )
            ],
          )
